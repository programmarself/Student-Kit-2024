...
st.markdown('<div class="footer"><p> Group Name : Programmarself </p></div>', unsafe_allow_html=True)
st.markdown('<div class="footer"><p> programmarself@gmail.com </p></div>', unsafe_allow_html=True)
